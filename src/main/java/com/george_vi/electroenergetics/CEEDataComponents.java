...
public class CEEDataComponents {
    ...
    public static final DataComponentType<InWorldNodeConnection> NODE_CONNECTION = register("node_connection", builder -> builder.persistent(InWorldNodeConnection.CODEC).networkSynchronized(InWorldNodeConnection.STREAM_CODEC));
