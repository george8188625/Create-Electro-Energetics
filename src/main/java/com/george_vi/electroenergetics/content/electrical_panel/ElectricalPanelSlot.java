...
public enum ElectricalPanelSlot implements StringRepresentable {
    FULL_SLOT(new AABB(2/16f, 2/16f, 9/16f, 14/16f, 14/16f, 15/16f), 0),
    HALF_UPPER(new AABB(2/16f, 8/16f, 9/16f, 14/16f, 14/16f, 15/16f), 0),
    HALF_LOWER(new AABB(2/16f, 2/16f, 9/16f, 14/16f, 8/16f, 15/16f), 6/16f),
    HALF_LEFT(new AABB(8/16f, 2/16f, 9/16f, 14/16f, 14/16f, 15/16f), 6/16f),
    HALF_RIGHT(new AABB(2/16f, 2/16f, 9/16f, 8/16f, 14/16f, 15/16f), 0),
    THIRD_LEFT(new AABB(10/16f, 2/16f, 9/16f, 14/16f, 14/16f, 15/16f), 8/16f),
    THIRD_CENTERED(new AABB(6/16f, 2/16f, 9/16f, 10/16f, 14/16f, 15/16f), 4/16f),
    THIRD_RIGHT(new AABB(2/16f, 2/16f, 9/16f, 6/16f, 14/16f, 15/16f), 0);

    public final AABB shape;
    public final Vec3 center;
    public final double leftOffset;

    ElectricalPanelSlot(AABB shape, double leftOffset) {
        this.shape = shape;
