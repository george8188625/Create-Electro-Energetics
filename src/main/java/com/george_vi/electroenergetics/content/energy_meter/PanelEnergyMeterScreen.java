...
public class PanelEnergyMeterScreen extends AbstractSimiScreen {
...
//        number1 = Math.round(number1 * 10) / 10f;
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if ((be.owner == null || (Minecraft.getInstance().player != null && Minecraft.getInstance().player.getUUID().equals(be.owner))) &&
                ...
                mouseY > disconnectY && mouseY <= disconnectY + 15) {
            CatnipServices.NETWORK.sendToServer(new ChangeEnergyMeterStatePacket(false, !be.disconnected, be.pos));
        }
        ...
        if ((be.owner == null || (Minecraft.getInstance().player != null && Minecraft.getInstance().player.getUUID().equals(be.owner))) &&
                ...
                mouseY > resetY && mouseY <= resetY + 15) {
            CatnipServices.NETWORK.sendToServer(new ChangeEnergyMeterStatePacket(true, be.disconnected, be.pos));
        }
