...
public record SimulatedDeviceType<T extends SimulatedDevice>(ResourceLocation id, SimulatedDeviceFactory<T> factory, Collection<Block> validBlocks) {
    ...
    public T create(ServerLevel level, BlockPos pos, DevicesSavedData sd) {
        return factory.create(level, pos, sd, this);
    }
}