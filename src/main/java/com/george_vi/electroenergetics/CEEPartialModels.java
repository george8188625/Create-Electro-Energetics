...
public class CEEPartialModels {
    ...
    public static final PartialModel ELECTRUM_WIRE_SEGMENT = PartialModel.of(CreateElecrtoEnergetics.rl("block/electrum_wire_segment"));
    ...
    public static final PartialModel PANTOGRAPH_BASE = PartialModel.of(CreateElecrtoEnergetics.rl("block/pantograph/base"));
    ...
    public static final PartialModel PANTOGRAPH_BASE_DOUBLE = PartialModel.of(CreateElecrtoEnergetics.rl("block/pantograph/base_double"));
    ...
    public static final PartialModel FUSE_HOLDER_SWITCH = PartialModel.of(CreateElecrtoEnergetics.rl("block/fuse_holder/switch"));
    public static final PartialModel FUSE_HOLDER_SWITCH_CLOSED = PartialModel.of(CreateElecrtoEnergetics.rl("block/fuse_holder/switch_closed"));
    public static final PartialModel FUSE_HOLDER_INDICATOR_BULB = PartialModel.of(CreateElecrtoEnergetics.rl("block/fuse_holder/indicator_bulb"));
